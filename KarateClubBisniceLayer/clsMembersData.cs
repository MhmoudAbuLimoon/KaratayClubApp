...
namespace KarateClubDataAccessLayer
{
    public class AddMemberDTO1 {
        ...
        public AddMemberDTO1() { }
        public AddMemberDTO1(int MemberID, int PersonID, int LastBeltRankID, bool IsActive)
        {
    ...
    public class MemberDTO2
    {
        ...
        //}
        public MemberDTO2(int MemberID, string Name, string RankName,
